...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  const activeStyle =
    "px-4 py-3 flex items-center text-teal-500 bg-teal-50 rounded-lg font-medium";
  const inactiveStyle =
    "px-4 py-3 flex items-center text-gray-600 hover:bg-gray-50 rounded-lg hover:text-teal-500 transition-colors duration-200";
  ...
  return (
    <div
      className={`fixed left-0 top-0 h-full w-64 bg-white shadow-lg z-40 transition-transform duration-300 ease-in-out ${visibilityClasses}`}
    >
      ...
      <div className="px-4 py-3 text-xs text-gray-400 font-medium mt-4">
        ACCOUNT
      </div>
      <div className="py-2 px-2">
        <NavLink
