...
const ComingSoon = ({ title }) => (
  <div className="p-8">
    <div className="bg-white rounded-xl p-8 shadow-sm">
      ...
      <p className="text-gray-600">This feature is coming soon. We're working hard to bring you the best experience!</p>
      ...
      <p className="text-center text-gray-500 mt-8">Check back soon for updates!</p>
    </div>
  </div>
);
...
const routes = [
  {
    ...
    children: [
      {
        path: '/',
        element: <Navigate to="/codeforces" replace />,
      },
      {
        path: '/codeforces',
        element: <CodeForces />,
      ...
      {
        path: '/qod',
        element: <ComingSoon title="Question of the Day" />,
      },
      {
        path: '/settings',
